...
<form action="../controllers/form-handlers/alterar-dados-participantes.php" method="POST">
    ...
    <div class="form-group row">
     <label class="col-sm-2 col-form-label" for="selectTurma"><strong>Turma</strong></label>
        <div class="col-sm-8 mb-3">
            
            <select class="form-control" name="turma_do_projeto" value="<?= $member["turma"]?>">
                <option><?php echo $member["turma"];?></option>
