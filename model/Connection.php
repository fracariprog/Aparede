...
//        participantes columns
        ...
        define("PARTICIPANTES_TURMA", 'turma');
...
//       image types
    ...
    public function registerProject($name, $abstract, $member_names, $member_emails, $class, $image, $image_type) {
    ...
    public function getProjectById($id) {
        ...
        $imgs = $this->executeQuery();
       
        while($img = $imgs->fetch_assoc()){
            array_push($imageInfo, $img);
        }
        $projectInfo["image"] = $imageInfo;
        return $projectInfo;
    }
    ...
    function updateMemberInfo($id, $name, $email, $class){
          $this->sql = "UPDATE " . TABLE_PARTICIPANTES 
                    . " SET " . PARTICIPANTES_NOME . " = '" .$name. "', ". PARTICIPANTES_EMAIL . " = '" .$email. "', " . PARTICIPANTES_TURMA . " = '" .$class. "'"
                    . " WHERE id = $id ;";
        $this->executeQuery();
    ...
    function updateEstadoProj($id, $estado, $data_exposicao){
        $this->sql = "UPDATE " . TABLE_PROJETOS 
                    . " SET " . PROJETOS_SITUACAO . " = '" .$estado. "', ". PROJETOS_DATA_EXPOSICAO . " = '" .$data_exposicao. "' "
                    . " WHERE id = $id ;";
        $this->executeQuery();
    }
    
    function updateProjInfo($id, $nome, $resumo){
        $this->sql = "UPDATE " . TABLE_PROJETOS 
                    . " SET " . PROJETOS_NOME . " = '" .$nome. "', ". PROJETOS_RESUMO . " = '" .$resumo. "' "
                    . " WHERE id = $id ;";
        $this->executeQuery();
    }

    function insertImageOnProject($id, $imagem){

        $this->sql = "INSERT INTO " . TABLE_IMAGENS . " ( " . IMAGENS_PROJETOS_ID . ", " . IMAGENS_IMAGEM.", " 
                        . IMAGENS_TIPO . ") VALUES ( ". $id .", '" . $this->connection->real_escape_string($imagem) . "', 1 ) ;";
